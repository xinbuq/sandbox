Cloned from: https://github.com/arcanericky/ga-cmd.git. Following changes have been made:
1. changed build.sh, do not clone from google-authenticator git
2. removed the submodule config of google-authenticator
3. changed ga-cmd.c. the new code picks the first command line argument as the secret key
